 ...
 * 
 */
public class VehiclesKuralPuzzleActivity extends Activity {

	public static Integer[] displayImagesVehiclesKural = {  R.drawable.vehicles_truck, R.drawable.vehicles_aeroplane,
			R.drawable.vehicle_satellite, R.drawable.vehicles_ship, R.drawable.vehicles_train, R.drawable.vehicles_car,
			R.drawable.vehicles_bus, R.drawable.vehiceles_fire_engine, R.drawable.vehicles_ambulance,
			};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.vehicles_kural_puzzle_view_layout);
		...
		OnClickListener nextSelector = new OnClickListener() {
			public void onClick(View v) {
				...
				if (imageNumber == displayImagesVehiclesKural.length) {
					imageNumber = 0;
				}
